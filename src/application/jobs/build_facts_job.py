...
class BuildFactsJob(Job):
    ...
    def __init__(self, job_id: str, project_id: str, builder_type: str, snapshot_id: str):
    ...
    def run(self, context) -> Any:
        ...
        logger.info(f"Building facts using {self.builder_type} for snapshot {self.snapshot_id}")
