# -*- coding: utf-8 -*-
"""
Bounded LM Studio control seam (Phase 4C).

Design constraints:
- No install/download/provisioning behavior.
- No runtime control during object construction.
- Machine-changing behavior only occurs inside explicit control methods.
"""
